...
const questions = [
    ...
    {
        question: 'who is the president of palestine?',
        options: ['netan yahu', 'mehmood abbas', 'antonio gotress', 'yasser arafat'],
        correctAnswer: 'mehmood abbas'
    },
    {
...
function askQuestion(questionData: any) {
