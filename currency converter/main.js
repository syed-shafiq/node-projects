...
const PkrToPounds = () => {
    console.log("Your Ammount After Convertion Will be: ", Ammount * 0.00297);
};
const DollarToPkr = () => {
    console.log("Your Ammount After Convertion Will be: ", Ammount * 277);
};
const DollarToPounds = () => {
    console.log("Your Ammount After Convertion Will be: ", Ammount * 0.82);
};
const PoundsToPkr = () => {
